...
internal static class Crc32CHashCalculator
{
    ...
    static Crc32CHashCalculator()
    {
        InitTable(Poly);
    }

    public static uint AppendHash(uint crc, in ReadOnlySpan<char> input, int offset, int length)
    {
    ...
    private static void InitTable(uint poly)
    {
        var table = Table;
