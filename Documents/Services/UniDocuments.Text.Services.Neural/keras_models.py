...
from keras.layers import Layer, Embedding, Input, Concatenate, LSTM, GRU, Dense, Lambda, Average, Flatten
...
class DocumentsStreamGenerator(DocumentsStream):
    ...
    def __init__(self, generator, options, data_handler):
    ...
    def __iter__(self) -> Iterator[Document]:
        ...
        while True:
            ...
            for paragraph in document.Paragraphs:
                ...
                yield Document(id=paragraph_id, tokens=words)
